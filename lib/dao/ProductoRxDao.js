...
/**
 * @description Función que permite consultar los productos existentes
 * @creation David Villanueva 09/01/2023
 * @update
 */
exports.consultarProductoDuplicado = async function (oFiltro) { 
    const oResponse = {};
    try {
        var oFiltroLista = {}; 
        oFiltroLista.where ={};  
