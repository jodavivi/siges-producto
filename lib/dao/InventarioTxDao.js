...
exports.crearInventario = async function (oParam) { 
    ...
    try {
        ...
        oRegistro.Factor                = oParam.oData.iFactor;
        oRegistro.Cantidad              = oParam.oData.fCantidad;
        oRegistro.PrecioCostoTotal      = oParam.oData.fPrecioCostoTotal;   
        oRegistro.CodEstadoInventario   = oParam.oData.iCodEstadoInventario;
        oRegistro.EstadoInventario      = oParam.oData.sEstadoInventario;
...
exports.actualizarInventario = async function (oParam) { 
    ...
    try {
        ...
        if(oParam.oData.iFactor !== undefined){
            oRegistro.Factor     = oParam.oData.iFactor; 
        }
        ...
        if(oParam.oData.iCodEstadoInventario !== undefined){
            oRegistro.CodEstadoInventario     = oParam.oData.iCodEstadoInventario; 
        }
        if(oParam.oData.sEstadoInventario !== undefined){
            oRegistro.EstadoInventario     = oParam.oData.sEstadoInventario; 
        }
        var oFiltro      = {};
        oFiltro.where    = {};
