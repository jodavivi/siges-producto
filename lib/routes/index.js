...
module.exports = function(){
    ...
    //producto
    router.post('/producto', productoTxBusiness.registrarProducto); 
    router.put('/producto/:id', productoTxBusiness.actualizarProducto); 
    router.delete('/producto/', productoTxBusiness.eliminarProducto);  
    router.get('/producto', productoRxBusiness.consultarProducto); 
